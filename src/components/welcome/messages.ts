...
export default defineMessages({
  ...
  cardDiscountsTitle: {
    id: 'Welcome.cardDiscountsTitle',
    defaultMessage: 'Discounts Overview',
  },
  cardDiscountsContent: {
    id: 'Welcome.cardDiscountsContent',
    defaultMessage:
      'View all product and cart discounts in a unified table with stamps and navigation.',
  },
});
